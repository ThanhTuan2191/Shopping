...
namespace Shopping.Data.Extensions
{
        ...
        public static void Seed(this ModelBuilder modelBuilder)
        {
           ...
           new Product()
           {
            ...
            modelBuilder.Entity<AppUser>().HasData(new AppUser
            {
                ...
                Email = "lequythanhtuan@gmail.com",
                NormalizedEmail = "lequythanhtuan@gmail.com",
                EmailConfirmed = true,
                PasswordHash = hasher.HashPassword(null, "thanhtuan"),
